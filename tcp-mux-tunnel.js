...
function main() {
  ...
  switch (args[0]) {
    case 'server':
      ...
      net.createServer({allowHalfOpen: true}, tunnel => {
          ...
          default:
            ...
            switch (req.op) {
              ...
              case 'on close':
                ...
                delete virtStreamMap[req.virtStreamId];
                break;
              case 'on error':
